            ...
            <StaggerContainer>
              ...
              <StaggerItem>
                <div className="mb-6 flex flex-wrap items-center gap-4">
                  ...
                  <span className="rounded-full bg-surface px-4 py-1.5 text-sm font-semibold text-title/80">
                    {product.size} tub
                  </span>
                </div>
              </StaggerItem>
              <StaggerItem>
                <p className="mb-4 text-sm text-title/65">
                  Online Ready Soups orders need at least {READY_SOUP_MIN_ORDER} soups. Mix flavours in a
                  bundle, or add individual tubs to reach the minimum.
                </p>
                <motion.div
